...
<head>
    <base href="../../../">
    <title>Sistem Informasi Pencatatan Pasien</title>
    <meta charset="utf-8" />
...
<div class="d-flex flex-column flex-root">
    ...
    <div class="d-flex flex-column flex-column-fluid 
        bgi-position-y-bottom position-x-center 
        ...
        <div class="d-flex flex-center flex-column flex-column-fluid p-10 pb-lg-20">
            ...
            <a href="#" class="mb-12 text-center">
                <h3 class="fw-bold text-primary">
                    Sistem Informasi Pencatatan Pasien
                </h3>
            </a>
            ...
            <div class="w-lg-500px bg-body rounded shadow-sm p-10 p-lg-15 mx-auto">
                ...
                <form method="POST" action="{{ route('login') }}" class="form w-100">
                    ...
                    <div class="text-center mb-10">
                        <h1 class="text-dark mb-3">Login Pengguna</h1>
        ...
        <div class="d-flex flex-center flex-column-auto p-10">
            <div class="d-flex align-items-center fw-bold fs-6">
                <span class="text-muted px-2">
                    © {{ date('Y') }} Sistem Informasi Pencatatan Pasien
                </span>
            </div>
        </div>
